	          ...
	          <div class="pool"> 
	            <ul>
	              <li ng-repeat="item in $ctrl.options.items | filter: $ctrl.searchItem | orderBy: $ctrl.options.orderProperty"> 
	                <a href="" ng-click="$ctrl.change($ctrl.options.items, $ctrl.options.selectedItems, $ctrl.options.items.indexOf(item))">{{item.name}}</a> 
	              </li>
	            </ul>
	          </div>
	        </div>
	          ...
	          <div class="pool">
	            <ul>
	              <li ng-repeat="item in $ctrl.options.selectedItems | orderBy: $ctrl.options.orderProperty">
	                <a href="" ng-click="$ctrl.change($ctrl.options.selectedItems, $ctrl.options.items, $ctrl.options.selectedItems.indexOf(item))">{{item.name}}</a>
	              </li>
	            </ul>
	          </div>
	        </div>
